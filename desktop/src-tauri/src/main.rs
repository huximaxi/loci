...
#[cfg(test)]
mod csp_gate_tests {
    // Tripwire for the instrument-egress invariant (rc.4, closing the PR #79
    // network-egress follow-up): palace-authored srcdoc instruments inherit the webview CSP, so
