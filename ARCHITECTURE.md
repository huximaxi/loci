...
- Grounding builders: `build_grounding`, `find_latest_handover_delta`, `build_companion_grounding`
...
1. Commit Phase 4b (two-brain provider, identity grounding) on `fix/phase35-harden-viewer`. That branch must land cleanly first.
