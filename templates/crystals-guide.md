...
**Example entries:**
```
◆ Owner: [YOUR_NAME] - [your role and where you work]
◆ Stack: [your primary tools, e.g. Next.js 14 / Postgres / Vercel]
◆ Core value: Simplicity first. No over-engineering.
◆ Working preference: Bullet points over prose. KISS, always.
```
...
◇ Framing: [a wording hypothesis you're testing, e.g. "Plain-language labels land better than technical ones for casual users"]
```
...
```
◇ Framing: [your wording hypothesis, e.g. "Plain-language labels beat technical ones"]
→ Promoted to ◈ 2026-04-15: confirmed by 3 user interviews. Still A/B testing.
→ Promoted to ◆ 2026-05-01: A/B concluded - plain-language wins across all segments.
```
