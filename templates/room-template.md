...
*(What's currently live in this room? List active work items. Claude will update these as you make progress.)*

| Project | Status | Next step |
|---|---|---|
| [Project name] | [active / paused / done] | [what's next] |

---

## Known context

*(Things Claude should reference before re-searching or re-deriving. Like a cheat sheet for this room.)*
...
## State summary
> [YOUR_NAME]: add 2-line state summary here at the start of each session
> e.g. "Last session: finished chapter 3 outline. Open: chapter 4 is stalled on the protagonist's motivation."
