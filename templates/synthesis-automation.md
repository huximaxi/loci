...
Add to your palace `CLAUDE.md` (or your global identity file):
...
- Output: `synthesis/`
- Gate: review before any write
```

Then create the output directory:
```bash
mkdir -p PALACE_ROOT/synthesis/
```

The agent will propose synthesis reports and save them to this directory. You review, modify, approve. Then the crystal table and garden files update.
