...
*Pattern by Loci · [loci.garden](https://loci.garden)*
...
| `[TICKET]` | An issue created or updated in your tracker |
...
| `[GATE]` | Human approval moment in the arc |
...
- **[security persona]:** adversarial analysis, security findings
