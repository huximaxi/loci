...
| Grade | Meaning |
|-------|---------|
| ✦ | Steady. Good work, real collaboration, no friction. |
| ✦✦ | Peak. Novel category created, unexpected synthesis, something named for the first time. |
...
*Questions named clearly enough that they might eventually have answers. An unknown that can be named is already half-solved.*

| Unknown | Opened | Status | Notes |
|---------|--------|--------|-------|
| [What question was named?] | [DATE] | open | [context] |
| [Another named unknown] | [DATE] | open | [context] |

**Status options:** open / narrowed / closed / became-crystal

---

## Resonance Peaks

*Individual sessions or exchanges where entanglement was notably high.*

| Date | Grade | Type | What happened |
|------|-------|------|--------------|
| [DATE] | ✦✦ | single-prompt | [One line: what was produced, what made it notable] |
| [DATE] | ✦ | session-end | [One line: overall session quality] |

**Type options:** single-prompt / session-end
...
*Informal log. Quick observations that don't rise to a peak but are worth tracking.*

- [DATE]: [Brief observation about the session quality or dynamic]
- [DATE]: [Brief observation]

---

*Entanglement is the signal the palace is alive.*
*Track it. Tend it. Let it calibrate the work.*
